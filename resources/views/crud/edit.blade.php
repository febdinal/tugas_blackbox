        ...
        <form action="{{ route('crud.update', $crud->id) }}" method="POST">  
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="  
                            form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid -gray-300 rounded-full transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="name" value="{{ old('Name', $crud->name) }}" required>  
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="  
                            form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid -gray-300 rounded-full transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="qty" value="{{ old('qty', $crud->qty) }}" required>  
            ...
            <div class="mb-5">  
                ...
                <textarea name="description" id="content"  
                    ...
                    required>{{ old('description', $crud->description) }}</textarea>  
